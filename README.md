...
| ------------------ | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Week 5 (Cont.)** | **Match Agent + Routing**   | Build Match Agent (`sub_agents/match.py`) for 0–100 resume scoring & skills gap analysis, and wire sub-agent nodes into LangGraph. |
